 ...
 *         "sig": "int connectedpixels_u16(const uint16_t *data, int32_t *labels, int threshold, int verbose, int eightconnected, intptr_t ns, intptr_t nf) -> int",
