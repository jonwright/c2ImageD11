 ...
 *         "sig": "int connectedpixels_u8(const uint8_t *data, int32_t *labels, int threshold, int verbose, int eightconnected, intptr_t ns, intptr_t nf) -> int",
...
int connectedpixels_u8(const uint8_t *data, int32_t *labels, int threshold, int verbose,
