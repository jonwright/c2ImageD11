...
extern "C" int score_f64_avx512(const double ubi[3][3], const double gv[], double tol, intptr_t ng)
{
    return dispatch_score_aos(score_f64_avx512_kernel, (const double *)ubi, gv, ng, tol);
}
