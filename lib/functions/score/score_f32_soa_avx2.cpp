...
extern "C" int score_f32_soa_avx2(const double ubi[3][3], const float gv[], double tol, intptr_t ng)
{
    return dispatch_score_soa(score_f32_soa_avx2_kernel, (const double *)ubi,
