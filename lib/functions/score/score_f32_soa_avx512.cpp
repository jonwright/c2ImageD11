...
extern "C" int score_f32_soa_avx512(const double ubi[3][3], const float gv[], double tol, intptr_t ng)
{
    return dispatch_score_soa(score_f32_soa_avx512_kernel, (const double *)ubi,
