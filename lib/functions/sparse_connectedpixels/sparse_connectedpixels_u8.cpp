 ...
 *         "sig": "int sparse_connectedpixels_u8(const uint8_t *v, const uint16_t *i, const uint16_t *j, intptr_t nnz, float threshold, int32_t *labels) -> int",
 *      "map": {"v": "v.ptr", "i": "i.ptr", "j": "j.ptr", "nnz": "i.n", "threshold": "threshold", "labels": "labels.ptr"}}]}
C2PY_END */

extern "C" int sparse_connectedpixels_u8(uint8_t *restrict v, uint16_t *restrict i,
