 ...
 *         "sig": "void blobproperties_u16(const uint16_t *data, const int32_t *labels, int32_t npk, float omega, int verbose, intptr_t ns, intptr_t nf, double *res)",
 *      "map": {"data": "data.ptr", "labels": "labels.ptr", "npk": "np", "omega": "omega", "verbose": "verbose", "ns": "data.shape[0]", "nf": "data.shape[1]", "res": "results.ptr"}}]}
C2PY_END */

void blobproperties_u16(const uint16_t *data, const int32_t *labels, int32_t npk, float omega,
