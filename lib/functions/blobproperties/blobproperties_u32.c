 ...
 *  "gil_release": true,
 *  "c_overloads": [{"when": "data.format == 'I' and data.ndim == 2 and data.slow_axis == 0",
...
void blobproperties_u32(const uint32_t *data, const int32_t *labels, int32_t npk, float omega,
