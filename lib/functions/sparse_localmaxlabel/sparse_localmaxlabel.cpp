...
extern "C"
int sparse_localmaxlabel(float * v, uint16_t * i,
                          uint16_t * j, intptr_t nnz,
                          float * MV,
                          int32_t * iMV,
                          int32_t * labels) {
    return sparse_localmaxlabel_impl<float>(v, i, j, nnz, MV, iMV, labels);
}
...
extern "C" int sparse_localmaxlabel_u8(uint8_t * v, uint16_t * i,
                                        uint16_t * j, intptr_t nnz,
                                        float * MV, int32_t * iMV,
                                        int32_t * labels) {
...
extern "C" int sparse_localmaxlabel_u16(uint16_t * v, uint16_t * i,
                                         uint16_t * j, intptr_t nnz,
                                         float * MV, int32_t * iMV,
                                         int32_t * labels) {
    return sparse_localmaxlabel_impl<uint16_t>(v, i, j, nnz, MV, iMV, labels);
}
...
extern "C" int sparse_localmaxlabel_u32(uint32_t * v, uint16_t * i,
                                         uint16_t * j, intptr_t nnz,
                                         float * MV, int32_t * iMV,
                                         int32_t * labels) {
    return sparse_localmaxlabel_impl<uint32_t>(v, i, j, nnz, MV, iMV, labels);
}
