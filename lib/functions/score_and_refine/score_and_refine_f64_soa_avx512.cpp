 ...
 *     "c_overloads": [{
 *         "when": "ubi.format == 'd' and gvx.format == 'd' and c2py_amd64_avx512f",
 *         "sig": "void score_and_refine_f64_soa_avx512(double ubi[3][3], const double gvx[], const double gvy[], const double gvz[], double tol, int *n_arg, double *sumdrlv2_arg, intptr_t ng)",
...
extern "C" void score_and_refine_f64_soa_avx512(double ubi[3][3], const double gvx[], const double gvy[], const double gvz[], double tol, int *n_arg, double *sumdrlv2_arg, intptr_t ng)
{
