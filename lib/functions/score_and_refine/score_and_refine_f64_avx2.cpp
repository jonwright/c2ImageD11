 ...
 *     "c_overloads": [{
 *         "when": "ubi.format == 'd' and gv.format == 'd' and c2py_amd64_avx2",
 *         "sig": "void score_and_refine_f64_avx2(double ubi[3][3], const double gv[][3], double tol, int *n_arg, double *sumdrlv2_arg, intptr_t ng)",
...
extern "C" void score_and_refine_f64_avx2(double ubi[3][3], const double gv[][3], double tol, int *n_arg, double *sumdrlv2_arg, intptr_t ng)
{
