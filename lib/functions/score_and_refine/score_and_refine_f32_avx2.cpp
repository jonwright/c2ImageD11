 ...
 *     "c_overloads": [{
 *         "when": "ubi.format == 'd' and gv.format == 'f' and c2py_amd64_avx2 and gv.shape[1] == 3 and gv.slow_axis == 0",
...
extern "C" void score_and_refine_f32_avx2(double ubi[3][3], const float gv[], double tol, int *n_arg, double *sumdrlv2_arg, intptr_t ng)
{
