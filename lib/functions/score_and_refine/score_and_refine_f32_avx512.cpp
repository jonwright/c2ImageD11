 ...
 *     "c_overloads": [{
 *         "when": "ubi.format == 'd' and gv.format == 'f' and c2py_amd64_avx512f",
 *         "sig": "void score_and_refine_f32_avx512(double ubi[3][3], const float gv[][3], double tol, int *n_arg, double *sumdrlv2_arg, intptr_t ng)",
...
extern "C" void score_and_refine_f32_avx512(double ubi[3][3], const float gv[][3], double tol, int *n_arg, double *sumdrlv2_arg, intptr_t ng)
{
