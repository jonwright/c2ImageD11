...
ENGINES = [
    {"suffix": "lz4",  "prefix": "bslz4",  "extra_flags": ""},
    {"suffix": "zstd", "prefix": "bszstd", "extra_flags": "-DUSE_ZSTD"},
]
...
def make_full_suffix(engine, backend, isa):
    """Full suffix used in object file names"""
    return "_{}_{}_{}".format(engine, backend, isa)
...
def generate_bs_functions_h():
    ...
    lines.append(BS_FUNCTIONS_H_HEADER.format(
        ...
        nengines=neng, nbackends=nbk, nisas=nisa))
